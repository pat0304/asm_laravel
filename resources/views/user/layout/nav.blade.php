    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <form class="position-relative" role="search">
                <input class="form-control rounded-5 ps-5" type="search" placeholder="Nhập tên sản phẩm..." aria-label="Search">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fs-6 fw-bold gap-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="/products/category/{{$i->id}}">{{$i->name}}</a></li>
                        @endforeach
                    </ul>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{route('auth.changePassword.index')}}">Đổi mật khẩu</a></li>
                        <li><form class="" action="{{route('auth.logout')}}" method="POST">
                            @csrf
